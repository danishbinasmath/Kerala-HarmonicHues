import {
  ...
  const PostWidget = ({
    ...
    const patchLike = async () => {
      const response = await fetch(`https://keralaharmonichues-server.onrender.com/posts/${postId}/like`, {
        method: "PATCH",
        headers: {
      ...
      <WidgetWrapper m="2rem 0">
        ...
        {picturePath && (
          <img
            ...
            src={`https://keralaharmonichues-server.onrender.com/assets/${picturePath}`}
          />
        )}
